...
cfg = Configurator(
    ...
    datasets={
        "jsons": [
            ...
            f"{localdir}/../HH4b_common/datasets/QCD-4Jets",
            f"{localdir}/../HH4b_common/datasets/TTbar_background_2024",
            f"{localdir}/../HH4b_common/datasets/VBFHHto4B_Par",
            f"{localdir}/../HH4b_common/datasets/GluGluHHto4B_Par",
