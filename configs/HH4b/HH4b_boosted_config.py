...
variables_dict = get_variables_dict(
    ...
    RANDOM_PT=False,
    VBF_VARIABLES=False,
    BKG_MORPHING=bool(config_options_dict["bkg_morphing_dnn"]),
...
sample_list = [
    ...
    "DATA_JetMET_JMENano_F_boosted_skimmed",
    "DATA_JetMET_JMENano_G_boosted_skimmed",
...
cfg = Configurator(
    ...
    datasets={
        "jsons": [
            f"{localdir}/../HH4b_common/datasets/old_boosted_skim/background_TTtoX_boosted_2022_postEE_skimmed_pnfs_redirector.json",
            f"{localdir}/../HH4b_common/datasets/old_boosted_skim/GluGlutoHHto4B_boosted_skimmed.json",
            f"{localdir}/../HH4b_common/datasets/DATA_ParkingHH.json",
            f"{localdir}/../HH4b_common/datasets/old_boosted_skim/DATA_JetMET_boosted_skimmed_local.json",
        ],
        "filter": {
            "samples": sample_list,
            "samples_exclude": [],
