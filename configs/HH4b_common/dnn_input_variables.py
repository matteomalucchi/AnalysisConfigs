...
bkg_morphing_boosted_dnn_input_variables = OrderedDict(
    {
        ...
        "hh_vec_DeltaPhi": ["HH", "dPhi"],
        "hh_vec_DeltaEta": ["HH", "dEta"],
        "dijet_mass": ["DiJetVBFCandidates:0", "mass"],
        "dijet_pt": ["DiJetVBFCandidates:0", "pt"],
        "dijet_eta": ["DiJetVBFCandidates:0", "eta"],
        "dijet_phi": ["DiJetVBFCandidates:0", "phi"],
        "dijet_DeltaR": ["DiJetVBFCandidates:0", "dEta"],
        "dijet_LeadingJet_pt": ["LeadingVBFJet:0", "pt"],
        "dijet_LeadingJet_eta": ["LeadingVBFJet:0", "eta"],
        "dijet_LeadingJet_phi": ["LeadingVBFJet:0", "phi"],
        "dijet_LeadingJet_mass": ["LeadingVBFJet:0", "mass"],
        "dijet_SubLeadingJet_pt": ["SubLeadingVBFJet:0", "pt"],
        "dijet_SubLeadingJet_eta": ["SubLeadingVBFJet:0", "eta"],
        "dijet_SubLeadingJet_phi": ["SubLeadingVBFJet:0", "phi"],
        "dijet_SubLeadingJet_mass": ["SubLeadingVBFJet:0", "mass"],
    }
)
