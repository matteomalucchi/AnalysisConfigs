...
onnx_model_dict |= {
    "spanet": "/work/tharte/datasets/output_spanet/spanet_hh4b_inclusive_5jets_100_pvary_loose_s300_btag12_bratio.onnx",  # spanet pt vary 0.3, 1.7, btagratio 345
}
...
config_options_dict |= {
    ...
    "add_jet_spanet": True,
    "spanet_input_name_list": ["log_pt", "eta", "phi", "btag12_ratioSubLead"],
} | onnx_model_dict
