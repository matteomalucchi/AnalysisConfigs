...
onnx_model_dict  |= {
    ...
    "sig_bkg_dnn": "/work/tharte/datasets/ML_pytorch/out/sig_bkg_classifier/1_15_10_6_sig_bkg_mixed_dataset_large_with_btag_pd_wide_CR_with_bestworst_rerun_high_score_region/run100/state_dict/model_best_epoch_21.onnx",
}
...
config_options_dict |= {
    ...
    "mixeddata": True,
    "expandCR": True,
    "save_chunk": "root://t3dcachedb03.psi.ch:1094//pnfs/psi.ch/cms/trivcat/store/user/tharte/HH4b/spanet_ptflat_Update_newLeptonVeto_3L1Cut_UpdateJetVetoMap_mixeddata_control_30_80_var000068_btag_pd_DNN_SvB_rerun_high_score",
}| onnx_model_dict
