...
config_options_dict |= {
    ...
    "random_pt": True,
    "rand_type": 0.3,
    "save_chunk":"root://t3dcachedb03.psi.ch:1094//pnfs/psi.ch/cms/trivcat/store/user/mmalucch/out_hh4b/VBF/out_ggf_vbf_spanet_input_AllKlambda_HiggsPairing/parquet_files/",
    # VBF
    "vbf_analysis": False,
}| onnx_model_dict
