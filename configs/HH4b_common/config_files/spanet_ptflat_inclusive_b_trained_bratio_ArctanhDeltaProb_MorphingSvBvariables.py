...
onnx_model_dict |= {
    ...
    "bkg_morphing_dnn": "/work/mmalucch/out_ML_pytorch/DNN_AN_1e-3_e20drop75_minDelta1em5_SPANet_inclusive_b_region_bratioAll_postEE_ArctanhDeltaProb_SvBvariables/best_models/average_model_from_onnx.onnx",  # only 2022_postEE, 20 k-folds, early stopping, 1e-5 minDelta, spanet pt vary
    "sig_bkg_dnn": "/work/mmalucch/out_ML_pytorch/DNN_SvB_1e-3_e20drop75_minDelta1em5_SPANet_inclusive_b_region_bratioAll_postEE_ArctanhDeltaProb_MorphingSvBvariables/state_dict/model_best_epoch_11.onnx",
}
...
config_options_dict |= {
    ...
    "bkg_morphing_dnn_input_variables": sig_bkg_dnn_ArctanhDeltaProb_input_variables,
