...
onnx_model_dict  |= {
    ...
    "sig_bkg_dnn": "/work/tharte/datasets/ML_pytorch/out/sig_bkg_classifier/1_15_10_6_sig_bkg_mixed_dataset_large_with_btag_pd_normal_CR_with_bestworst_only/run100/state_dict/model_best_epoch_36.onnx",  # DeltaProb
}
...
config_options_dict |= {
    ...
    "mixeddata": True,
    "expandCR": False,
    "save_chunk": "root://t3dcachedb03.psi.ch:1094//pnfs/psi.ch/cms/trivcat/store/user/tharte/HH4b/spanet_1_15_10_6_mixed_large_dataset_normalCR_bestworst_only",
}| onnx_model_dict
