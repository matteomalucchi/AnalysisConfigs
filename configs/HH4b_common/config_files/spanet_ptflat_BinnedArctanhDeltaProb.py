...
onnx_model_dict  |= {
    ...
    # "sig_bkg_dnn": "/work/mmalucch/out_ML_pytorch/DNN_ptFlatSPANet_class_weights_e5drop75_postEE_allklambda_BinnedArctanhDeltaProb_BinnedMorphing/state_dict/model_best_epoch_4.onnx",
}
