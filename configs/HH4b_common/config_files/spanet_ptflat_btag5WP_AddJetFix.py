...
onnx_model_dict |= {
    ...
    "bkg_morphing_dnn": "/work/mmalucch/out_ML_pytorch/hh4b_bkg_reweighting/DNN_AN_1e-3_e20drop75_minDelta1em5_SPANet_btag5WP_postEE_AddJetFix/best_models/average_model_from_onnx.onnx",
    "sig_bkg_dnn": "/work/mmalucch/out_ML_pytorch/hh4b_sig_bkg_classifier/DNN_AN_1e-3_e20drop75_minDelta1em5_SPANet_btag5WP_postEE_AddJetFix/run100/state_dict/model_best_epoch_32.onnx",
}
...
config_options_dict |= {
    ...
    "old_wp_def": True,
    "qt_postEE": "/work/mmalucch/out_hh4b/bkg_morphing_studies/out_MC_DATA_spanet_ptflat_btag5WP_AddJetFix_BkgMorphing/quantile_transformer/SRSpanet_qt/qt_events_sig_bkg_dnn_score_kl_1.00.pkl",
} | onnx_model_dict
