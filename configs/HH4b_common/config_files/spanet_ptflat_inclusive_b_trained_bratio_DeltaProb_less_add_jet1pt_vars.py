from configs.HH4b_common.dnn_input_variables import (
    ...
    sig_bkg_dnn_DeltaProb_input_variables_less_add_jet1pt_vars,
)
...
onnx_model_dict |= {
    ...
    "sig_bkg_dnn": "/work/tharte/datasets/ML_pytorch/out/sig_bkg_classifier/DNN_AN_1e-3_e20drop75_minDelta1em5_SPANet_inclusive_b_region_bratioAll_postEE_DeltaProb_less_add_jet1pt_vars_no_add_jet1pt_Leading_and_Subleading_params/run100/state_dict/model_best_epoch_18.onnx",
}
...
config_options_dict |= {
    ...
    "sig_bkg_dnn_input_variables": sig_bkg_dnn_DeltaProb_input_variables_less_add_jet1pt_vars,
